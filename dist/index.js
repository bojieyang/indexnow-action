...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const sitemap_processor_1 = __importDefault(__nccwpck_require__(3120));
function run() {
...
const timeout_signal_1 = __importDefault(__nccwpck_require__(7960));
const utils_1 = __nccwpck_require__(1314);
    ...
    async fetch(urlString, timeout) {
        ...
        try {
            const options = {
                ...
                signal: (0, timeout_signal_1.default)(timeout)
            };
            const response = await (0, cross_fetch_1.default)(url.href, options);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const sitemap_fetcher_1 = __nccwpck_require__(5303);
const sitemap_indictor_1 = __nccwpck_require__(8725);
const xml_parser_1 = __nccwpck_require__(3544);
const inputs_1 = __nccwpck_require__(7063);
const utils_1 = __nccwpck_require__(1314);
const sitemap_filter_1 = __nccwpck_require__(9467);
...
class SitemapSubmitter {
    async submit(sitemaps, options) {
        ...
        const submitOptions = {
            ...
            signal: (0, timeout_signal_1.default)(options.timeout),
            method: 'POST',
            headers: {
        ...
        try {
            const submitResponse = await (0, cross_fetch_1.default)(submitUrl, submitOptions);
